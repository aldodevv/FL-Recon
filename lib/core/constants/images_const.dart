...
class ImagesConst {
  static final String _base =
      '${dotenv.env['APP_PUBLIC_ASSETS']}/mobile/images';
  ...
  static final String logoQlolaTransparent =
      '$_base/logo_qlola_transparent.png';
  ...
  static final String backgroundQlolaTabletLandscape =
      '$_base/qlola-bg-landscape.png';
  ...
  static const String localLogoQlolaShadow =
      'assets/images/logo_qlola_shadow.png';
  static const String localLogoBriPutih = 'assets/images/logo_white.png';
  static const String localLogoQlolaTransparent =
      'assets/images/logo_qlola_transparent.png';
  ...
  static const String localBackgroundQlolaTablet =
      'assets/images/qlola-bg-tab.png';
  static const String localBackgroundQlolaTabletLandscape =
      'assets/images/qlola-bg-landscape.png';
  static const String localBackgroundStickyHeader =
      'assets/images/sticky_header.png';
  static const String localLostConnection =
      'assets/images/ic_lostconnection.png';
}
